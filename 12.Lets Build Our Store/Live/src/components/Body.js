    ...
    return (allRestaurants?.length === 0) ? <Shimmer /> : (
        <div className="body">
            <div className="search-container p-5 bg-pink-50 my-5">
                <input value={searchTxt} type="text" className="search p-1 focus:bg-blue-200"
                    placeholder="Search..."
                ...
                }} className="search-btn p-1 m-2 bg-purple-900 hover:bg-green-900 text-white rounded-lg">
                    Search</button>
                ...
                <input value={user.name} onChange={(e) => setUser({
                    ...
                    className="p-1 focus:bg-blue-200" type="text" />
